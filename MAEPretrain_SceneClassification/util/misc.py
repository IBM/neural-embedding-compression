...
class SmoothedValue(object):
    ...
    def synchronize_between_processes(self, device=0):
        """
...
def save_model(args, epoch, model, model_without_ddp, optimizer, loss_scaler, latest=False):
...
def all_reduce_mean(x, device=0):
